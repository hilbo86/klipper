...
class LoadCellProbe:
    def __init__(self, config):
        ...
        # units)
        self._noise_level = config.getfloat("noise_level", above=0.0,
                                            default=1e-3)
        ...
        self._params = {}
        self._params["lift_speed"] = config.getfloat(
            "lift_speed", above=0.0, default=SPEED
        )
        self._params["probe_speed"] = config.getfloat(
            "probe_speed", above=0.0, default=SPEED
        )
    ...
    def _lower_to_threshold(self, gcmd):
        ...
        while True:
            # Check threshold before first movement, to prevent doing an
            # unchecked step after a retry
        ...
        while True:
            ...
            if attempt_dist < 2 * self._step_size:
                ...
                if attempt > MAX_RETRY:
                    raise gcmd.error(
                        "Force reading drifting too much, maximum "
                        "retries exceeded."
                    )
            else:
                attempt = 0
    ...
    def cmd_PROBE_ACCURACY(self, gcmd):
        ...
        gcmd.respond_info(
            ...
            " lift_speed=%.1f)\n"
            % (pos[0], pos[1], pos[2], sample_count,
    ...
    def cmd_LCP_CALIB_WEIGHT(self, gcmd):
        ...
        gcmd.respond_info("New force_calibration = %.6f:" \
